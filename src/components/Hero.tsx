  ...
  return (
    <div className="relative min-h-screen w-full bg-[#fff6db] bg-gradient-to-b from-[#3b82f6] from-30% via-[#fff6db] via-90% xl:flex">
      <div className="flex flex-col items-center gap-6 p-4 xl:mt-20 xl:items-start xl:p-8 2xl:mt-24 2xl:items-center 2xl:gap-12">
        ...
        <div className="hero-about-text relative w-full max-w-[800px] translate-y-50 rounded-2xl bg-white bg-[linear-gradient(to_right,#0000001a_1px,transparent_1px),linear-gradient(to_bottom,#0000001a_1px,transparent_1px)] bg-[size:20px_20px] p-8 opacity-0 shadow-[-10px_10px_0px_0px_#6D28D9] md:p-10 xl:w-[500px] 2xl:w-full">
          <p
